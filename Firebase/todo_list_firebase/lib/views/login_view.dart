...
class _LoginViewState extends State<LoginView> {
  // atributos
  final FirebaseAuth _auth = FirebaseAuth.instance; // operar a autenticação do usuário no firebase
  ...
  void _login() async{
    ...
    } on FirebaseAuthException catch (e) { // tratar o erro mais específico
      // tratar o erro
